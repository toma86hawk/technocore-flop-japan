# -*- coding: utf-8 -*-
"""Round 176 readback: confirm our 15 verdicts from the room export, not the relay tape.
...
log = json.load(open(r"C:\Users\Administrator\flop\guide\_r176_attest_log.json", encoding="utf-8"))
want = {x["job"]: x for x in log}

rows = []
for line in open(r"C:\Users\Administrator\flop\guide\_r176_kibble.jsonl", encoding="utf-8"):
    line = line.strip()
    if line:
        try:
